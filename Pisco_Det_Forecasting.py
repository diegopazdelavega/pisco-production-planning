...
class PiscoModel_Operativo: 
    ...
    def Cargar_Pronostico_Determinista(self, ruta_csv, dia_actual):
        ...
        print("Pronóstico cargado exitosamente en la memoria del modelo determinista.")
    ...
    def Problema(self):
        ...
        def D_nt(model, n, t):
            ...
            return self.Demanda_Determinista.get((n_name, t), 0.0) 
    ...
    def Solver(self):
        ...
        try:
            solver = create_gurobi_solver({"TimeLimit": 1800})
...
if __name__ == "__main__":
    ...
    modelo.ReadExcelFile(r"Datos_Originales.xlsx")
    
    # Cargar los escenarios de demanda usando el modelo de Forecasting de Clark (2005)
    # Suponiendo que estamos en la Iteración 0 (Día 0) del Rolling Horizon:
    modelo.Cargar_Pronostico_Determinista(
        ruta_csv="Evolucion_Pronosticos.xlsx",
        dia_actual=0          # en RH periodo 1, el día actual es 0, periodo 2 el dia actual es 30, periodo 3 dia actual es 60, etc.           
    )
    
    # 3. Construir modelo y resolver
